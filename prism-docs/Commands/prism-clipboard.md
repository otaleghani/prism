...
A clipboard history manager for Prism. It provides a visual interface to browse, search, and restore previously copied text and images. It leverages [[cliphist]] for storage and [[rofi]] for the selection UI.
