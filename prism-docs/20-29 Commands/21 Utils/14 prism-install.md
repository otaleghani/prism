...
> Packages installed via this tool are managed "imperatively." This means they are installed for the current user session and won't necessarily persist if you wipe your user directory, unlike "declarative" packages defined in your system configuration. To remove them, use [[02 prism-delete]].