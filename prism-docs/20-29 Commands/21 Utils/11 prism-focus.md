...
The core window management utility for the "single-instance" workflow in Prism. This script intelligently switches focus to an existing window if it's already open, or launches the application if it isn't. It serves as the backend logic for [[12 prism-focus-tui]] and [[13 prism-focus-webapp]].
