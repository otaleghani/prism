...
The primary application launcher for Prism. It triggers [[08 Rofi]] in "desktop run" mode, allowing users to quickly search for and launch installed graphical applications based on their `.desktop` entries.
