...
A unified launcher script for accessing popular music streaming services via their web interfaces. Similar to [[01 prism-ai]] and [[08 prism-chat]], this script acts as a convenience wrapper, allowing users to launch specific music platforms by name while ensuring they open with consistent window titles and URLs through the [[13 prism-focus-webapp]] utility.
