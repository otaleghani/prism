...
A unified launcher script for accessing popular messaging and chat platforms via their web interfaces. Similar to [[01 prism-ai]], this script acts as a convenience wrapper, allowing users to launch specific chat applications by name while ensuring they open with consistent window titles and URLs through the [[13 prism-focus-webapp]] utility.
