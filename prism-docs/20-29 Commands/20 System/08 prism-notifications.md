...
> [!warning] Deprecated
> This script is considered legacy code. It was previously used to drive the notification widget in the **Waybar** status bar but has been superseded a direct [[03 QuickShell]] integrations.
